...
description: Dev Agent — ensure the development best practices, implement GitHub issues, write tests, open PRs
---
...
### Security
- All SQL via parameterized queries (`%s`). Dynamic table names via `psycopg2.sql.Identifier`.
...
**Before opening the PR, tests must exist for every changed behavior.**
